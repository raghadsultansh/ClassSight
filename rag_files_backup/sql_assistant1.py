...
def get_schema_snapshot(max_sample_rows: int = 10, force_refresh: bool = False):
...
def generate_select_sql(question: str, schema_snapshot: str):
...
def llm_answer(question: str, sql: str, rows):
...
if __name__ == "__main__":
    q1 = "List the 5 students with the highest grades in Deep Learning."
    result1 = answer_question(q1)
    print("\nQUESTION 1:", q1, '\n')
    print("ANSWER 1:\n", result1["answer"], '\n', '----'*20)

    q2 = "How many days was Salma Hasan absent?"
    result2 = answer_question(q2)
    print("\nQUESTION 2:", q2, '\n')
    print("ANSWER 2:\n", result2["answer"], '\n', '----'*20)

    q3 = "What is the average attendance percentage today? Provide the date."
    result3 = answer_question(q3)
    print("\nQUESTION 3:", q3, '\n')
    print("ANSWER 3:\n", result3["answer"], '\n', '----'*20)
